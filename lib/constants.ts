...
export const voiceOptions = {
    ...
    chris: { id: 'iP95p4xoKVk53GoZ742B', name: 'Chris', description: 'Male, casual & easy-going' },
     jon: { id: 'sB7vwSCyX0tQmU24cW2C', name: 'Jon', description: 'Male, natural authority' },
    // Female voices
    ...
    sarah: { id: 'EXAVITQu4vr4xnSDxMaL', name: 'Sarah', description: 'Young female, American, soft & approachable' },
     victoria: { id: 'qSeXEcewz7tA0Q0qk9fH', name: 'Victoria', description: ' Warm, Trustworthy, and Relatable' },
      ivy: { id: 'MClEFoImJXBTgLwdLI5n', name: 'Ivy', description: 'Sassy Female, Bold Energy ' },
};

// Voice categories for the selector UI
export const voiceCategories = {
    male: ['dave', 'daniel', 'chris','jon'],
    female: ['rachel', 'sarah','victoria','ivy'],
};
